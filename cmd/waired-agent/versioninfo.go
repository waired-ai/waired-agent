...
// Windows VERSIONINFO resource. Without this, waired-agent.exe carries no
// version resource: Explorer's Properties dialog and Task Manager's
// "Details" column show nothing for the daemon, and every CodeIntegrity
// event and third-party tool that quotes a file version quotes 0.0.0.0
// (waired-agent#1209). The resource makes them show "Waired Agent" — the
// same name the Windows service registers under
// (internal/platform/service.DisplayName) — and the version this build
// actually is.
//
