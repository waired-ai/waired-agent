...
func TestClaudeSubDisplay(t *testing.T) {
	cases := []struct {
		...
		},
		{
			...
			want: "same as main  (waired — Waired only; Claude Code's permission check goes to Anthropic)",
		},
		{
		...
		},
		{
			...
			want: "waired  (Waired only; Claude Code's permission check goes to Anthropic)",
		},
	}
