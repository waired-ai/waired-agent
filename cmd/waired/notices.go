...
// (ascii.go). Info's is an arrow because the Info notice today is a
// newer Waired release being available (the step-up model suggestion that
// shared it is retired, waired-ai/waired-agent#1342) — a record of today's
// producers, not a rule about severities.
