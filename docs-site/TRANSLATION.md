...
| benchmark (旧 speed check / speed test / measure how fast this computer runs AI) | ベンチマーク | `Benchmarking this computer with a small model — one-time, a few minutes…`(引用は逐語)。「速度テスト」「速度チェック」としない | オーナー裁定(20260822; waired-ai/waired#1272; `docs/decisions/20260822/2029-user-copy-uses-standard-llm-terms.md`) |
